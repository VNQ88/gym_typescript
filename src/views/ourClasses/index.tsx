...
const OurClasses: React.FunctionComponent<IOurClassesProps> = ({
  setSelectedPage,
}: IOurClassesProps) => {
  return (
    <section id="ourclasses" className="w-full bg-primary-100 py-40">
      ...
      >
        ...
        >
        <div className="md:w-3/5 items-center justify-center text-justify">
            <HText className="">OUR CLASSES</HText>
            <p className="py-5">
